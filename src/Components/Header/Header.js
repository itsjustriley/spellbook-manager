  ...
  return (
    <header className="bg-light-purple flex justify-between items-center p-10 mb-10 sticky top-0">
      ...
      <ul className="flex pr-10 text-medium-purple">
        <li className="mr-10">
          <a className={`hover:text-white`} href="/">Prepared Spells</a>
        </li>
        <li className="mr-10">
          <a className="hover:text-white" href="/known">Spells Known</a>
        </li>
        <li>
          <a className="hover:text-white" href="/search">Spell Search</a>
        </li>
      </ul>
    </header>
  );
