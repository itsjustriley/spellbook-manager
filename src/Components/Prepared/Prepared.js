  ...
  return (
    <div>
      ...
      {knownSpells.length === 0 ? 
        <button className="bg-purple hover:bg-light-purple text-white font-bold py-2 px-4 rounded mb-4" onClick={() => window.location.href = "spellbook-manager#search"}>Learn Spells</button> :
        <button className="bg-purple hover:bg-light-purple text-white font-bold py-1 px-4 rounded mb-4" onClick={() => window.location.href = "spellbook-manager#known"}>View Known Spells</button>
        }
      <ul>
